...
4 - Normalmente as imagens já possuem um usuário criado para a execução de nossos apps .
...
CMD [“node”, “index.js”]
 ...
 5 - O Docker possui um cache de memória, que mantém armazenados, camadas de imagens após seu processo de build. E alguma alteração feita no Dockerfile, apenas aquela modificação que será buildada.  
